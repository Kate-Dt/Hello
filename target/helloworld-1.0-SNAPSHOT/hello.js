...
function greetByPeriod(){
	...
	var period = document.getElementById("period field").value;
	var request = gape.client.helloworldendpoints.greetByPeriod({'name':name,
		'period':period});
	
	request.execute(sayHelloCallback);
}

function greetByAdjectiveAndPeriod(){
	var name = document.getElementById("name field").value;
	var period = document.getElementById("period field").value;
	var adjective = document.getElementById("adjective field").value;
	var request = gape.client.helloworldendpoints.greetWithAdjective({'name':name, 'adjective':adjective,
		'period':period});
