...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name="greetWithAdjective", path = "greetWithAdjective",
    		httpMethod = HttpMethod.GET)

    public HelloClass greetWithAdjective(@Named("name") String name,
       		@Named("adjective") String adjective, @Named("period") String period) {
       	return new HelloClass(name, adjective, period);
    }
